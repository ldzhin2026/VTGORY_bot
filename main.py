...
(<a href='https://vtgori.pro/guidegive/'>инструкция здесь</a>)\n
...
☝️ Начисление возможно только нашему рефералу (тому кто зарегистрировался по нашей ссылке)", reply_markup=kb, parse_mode="Markdown")
        await state.clear()
